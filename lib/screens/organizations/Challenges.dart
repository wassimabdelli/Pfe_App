...
class _ChallengesState extends State<Challenges> {
              ...
              itemBuilder: (context, index)
                {
                  ...
                  var type  = challenges[index]['type'];
                  return Padding(
  ...
  void takephoto(ImageSource source,id,idCh) async {
    ...
    if (_imgFile != null)
    {
      var e = await Associnfos(id, 'email') ;

     var imgCh = await upload(_imgFile, e.toString(), "Association");
      addRepCh(idCh,id,imgCh,"assoc");
      showDialog(
        context: context,
        builder: (BuildContext context) {
          return AlertDialog(
