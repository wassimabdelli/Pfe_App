                      ...
                      builder: (context, snapshot) {
                        ...
                        return IconButton(onPressed:(){
                              ...
                              showMenu(
                                ...
                                if (value == 'settings') {
                                  Navigator.pushNamed(context, '/SettingAcount',arguments:'$id;$MyId');
                                }else{
                                  Navigator.pushNamed(context, '/ListFriend',arguments:'$id;$MyId');
                                }
                              });
                          },

                            icon: Icon(Icons.perm_device_information,color: appbarBackgroundColor,)
                        );
                              }else{
                                     ...
                                     children: [
                                       IconButton(
                                         icon: Icon(Icons.person_add,
                                             color: appbarBackgroundColor),
                                         onPressed: () {
                                           // Fonctionnalité d'ajout d'amis ici
                                         },
                                       ),
                                       SizedBox(width: 10,),
                                       ElevatedButton(
